<div class="container">
    ...
    <img class="" src="<?php echo get_template_directory_uri(); ?>./components/services-card-users/img2/css-3.png" alt="" />
   ...
   <div class="flex justify-evenly w-14 h-14">
    ...
    <img class="" src="<?php echo get_template_directory_uri(); ?>./components/services-card-users/img2/location.png" alt="" />
    <img class="" src="<?php echo get_template_directory_uri(); ?>./components/services-card-users/img2/loupe.png" alt="" />
    <img class="" src="<?php echo get_template_directory_uri(); ?>./components/services-card-users/img2/shopping-cart.png" alt="" />
    <img class="" src="<?php echo get_template_directory_uri(); ?>./components/services-card-users/img2/smartphone-call.png" alt="" /> 
   </div>
