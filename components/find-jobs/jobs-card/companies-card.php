<div class="company bg-white rounded-3xl shadow-3xl w-full">
    <?php if( have_rows('jobs') ): ?>
        ...
        <div class="company-card">
            <div class="side front p-6 pb-2">
                <div class="header-card w-full flex justify-between  items-center gap-4 md:gap-2 h-12">
                ...
                <div class="skill-required flex justify-evenly gap-4 xl:grid xl:grid-cols-2 pt-6 h-14 xl:justify-center">
                <?php
                if( have_rows('skills_required') ):?>
                    <?php while ( have_rows('skills_required') ) : the_row();
                        $sub_value = get_sub_field('name_of_the_skill');
                        ?>
                        <p class="skill px-2 border-solid border-sky-700 rounded-xl border-2 text-center"><?php echo $sub_value;?></p>
                    <?php endwhile; ?>
                <?php endif; ?>
            </div>
            ...
            <div class="side back p-6 pb-2 flex flex-col items-center justify-center">
            <div class="job-info w-full py-8">
                <p class="information text-center "><?php echo wp_trim_words( get_the_content(), 12); ?></p>
            </div>
    <?php endwhile; ?>
<?php endif; ?>
