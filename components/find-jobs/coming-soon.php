<?php if( have_rows('register_as_company') ): ?>
        ...
        <div class="timer-svg md:mb-20 2xl:w-5/12 xl:w-4/12 md:w-8/12 flex ml-16">
            <img class="h-64 md:w-9/12" src="<?php echo esc_url( $image['url'] ); ?>" alt="<?php echo esc_attr( $image['alt'] ); ?>" />
        </div>
