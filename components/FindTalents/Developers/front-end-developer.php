<div class="user-card bg-white rounded-3xl">
            ...
            <div class="user p-2  px-4 ">
                ...
                <div class="flex items-center justify-end mt-4 w-full border-solid border-t border-gray-600">
                    <button type="button" class="text-white bg-customGreen hover:bg-green-800  rounded-full text-sm px-4 py-2 text-center flex items-center mt-3 w-4/12 ">
                    More Info
                    </button>
                </div>
            </div>
