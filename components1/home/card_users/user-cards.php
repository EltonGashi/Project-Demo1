  ...
  <!-- For 4 columns - https://www.section.io/engineering-education/using-tailwind-css-grid-classes/  -->
    ...
    <div class=" px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6 p-5 mt-4">
      <div class="rounded-lg  max-w-sm">
        <a href="#!">
          <img class="rounded-t-lg" src="<?php echo get_template_directory_uri(); ?>./components1/home/assets/img/main.png" alt="" />
        </a>
        <div class="p-6 bg-white">
          <div class="flex items-center gap-6 mt-1">
            <img class="w-10 h-10" src="<?php echo get_template_directory_uri(); ?>./components1/home/assets/img/ellipse1.png">
          ...
          <div class="flex items-center gap-1">
            <img class="w-5 h-5" src="<?php echo get_template_directory_uri(); ?>./components1/home/assets/img/Star.png">
            <p class="">5.0</p>
          </div>
          <hr class="mt-4">
          <div class="flex items-center justify-between mt-4">
            <img class="w-5 h-5 mt-4" src="<?php echo get_template_directory_uri(); ?>./components1/home/assets/img/Heart.png">
            <button type="button" class="text-white bg-green-700 hover:bg-green-800  rounded-full text-xs px-4 py-2 text-center flex items-center ">
              Like and start talk
              <img src="<?php echo get_template_directory_uri(); ?>./components1/home/assets/img/like.png">
            </button>
          </div>
        </div>
